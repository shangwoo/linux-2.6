...
/*Used with drivers/i2c/chips/eeprom.c, 0NE-byte address-cycles, 256 bytes limited, resd only.*/
...
const struct i2c_board_info *i2c_eeprom_board_info_pointer = &i2c_eeprom_board_info;

/*Used with drivers/i2c/chips/at24.c, ONE/TWO address-cycles, multi-capacity, read/write support.*/
/*****************************************/
//ATMEL_24C256
...
const struct i2c_board_info *i2c_at24_eeprom_board_info_pointer = &i2c_at24_board_info;
#endif
...
const struct i2c_board_info *i2c_ft5x06_board_info_pointer = &i2c_ft5x06_board_info;
...
const struct spi_board_info *spi_controller_dummy_board_info_pointer = &spi_controller_dummy_board_info;
...
const struct spi_board_info *alp_spi_flash_board_info_pointer = &alp_spi_flash_board_info;
...
const struct spi_board_info *qspi_controller_dummy_board_info_pointer = &qspi_controller_dummy_board_info;
...
const struct spi_board_info *alp_qspi_flash_board_info_pointer = &alp_qspi_flash_board_info;
...
const struct spi_board_info *alp_mtd_qspi_flash_board_info_pointer = &alp_mtd_qspi_flash_board_info;
...
static void __init as9260_init(void)
{
    ...
    asm9260_gpio_init(); // must init before any other devices which may use gpio pins
...
#else
#ifdef CONFIG_MTD_ASM9260_SPI_FLASH
	/* Kernel could be booted from SPI FLASH if configure CONFIG_MTD_ASM9260_SPI_FLASH*/
...
MACHINE_START(AS9260, "AS9260")
    ...
    .io_pg_offst	= ((0xfef00000) >> 18) & 0xfffc,  /* we use the value in version1.*/  
