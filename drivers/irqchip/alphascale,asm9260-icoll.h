...
/* ASM9260_BM_CTRL_SFTRST and ASM9260_BM_CTRL_CLKGATE are not available on asm9260. */
 ...
 * by the read of the ASM9260_HW_ICOLL_VECTOR register to acquire the interrupt vector
 * address. Set this bit to zero for normal operation, in which the ISR signals
 * in-service explicitly by means of a write to the ASM9260_HW_ICOLL_VECTOR register.
