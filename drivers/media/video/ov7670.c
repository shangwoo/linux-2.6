 ...
 *
 * Copyright (C) 2012   alpscale Inc. Written
 * by Jonathan Corbet with substantial inspiration from Mark
 * McClelland's ovcamchip code.
 *
 *Revised by Shanjs <shanjs@alpscale.cn>.
 *
...
static struct regval_list ov7670_default_regs[] = {
	{REG_COM1, 0x40}, {REG_COM15, 0x10},{REG_TSLB, 0x0D},	
	{REG_COM13, 0xC1},{REG_COM7, 0x14}, {REG_COM3, 0x00}, 
	{REG_COM14, 0x00},{0x70, 0x00}, {0x71, 0x00}, {0x72, 0x11}, 
	{0x73, 0x00},{0xa2, 0x02}, {REG_CLKRC, 0x01},{0x7a, 0x20},
	...
	{REG_COM8, 0xe0}, {REG_GAIN, 0x00},{REG_AECH, 0x00}, 
	{REG_COM4, 0x00}, {REG_COM9, 0x28},{REG_BD50MAX, 0x05}, 
	{REG_BD60MAX, 0x07}, {REG_AEW, 0x75}, {REG_AEB, 0x63}, 
	{REG_VPT, 0xA5}, {REG_HAECC1, 0x78}, {REG_HAECC2, 0x68}, 
	{0xa1, 0x03},{REG_HAECC3, 0xdf},{REG_HAECC4, 0xdf},
	{REG_HAECC5, 0xf0}, {REG_HAECC6, 0x90}, {REG_HAECC7, 0x94}, 
	{REG_COM8, 0xe5}, {REG_COM5, 0x61}, {REG_COM6, 0x4b}, 
	{0x16, 0x02}, {REG_MVFP, 0x07},{0x21, 0x02}, {0x22, 0x91}, 
	{0x29, 0x07}, {0x33, 0x0b}, {0x35, 0x0b}, {0x37, 0x1d}, 
	{0x38, 0x71}, {0x39, 0x2a}, {REG_COM12, 0x78}, {0x4d, 0x40}, 
	{0x4e, 0x20}, {REG_GFIX, 0x00}, {0x6b, 0x4a},{0x74, 0x19}, 
	{0x8d, 0x4f}, {0x8e, 0x00}, {0x8f, 0x00}, {0x90, 0x00}, 
	{0x91, 0x00}, {0x92, 0x00},{0x96, 0x00}, {0x9a, 0x80}, 
	{0xb0, 0x84}, {0xb1, 0x0c}, {0xb2, 0x0e}, {0xb3, 0x82}, 
	{0xb8, 0x0a}, {0x43, 0x14}, {0x44, 0xf0}, {0x45, 0x34}, 
	{0x46, 0x58}, {0x47, 0x28}, {0x48, 0x3a}, {0x59, 0x88}, 
	{0x5a, 0x88}, {0x5b, 0x44}, {0x5c, 0x67}, {0x5d, 0x49}, 
	{0x5e, 0x0e}, {0x64, 0x04}, {0x65, 0x20}, {0x66, 0x05}, 
	{0x94, 0x04}, {0x95, 0x08}, {0x6c, 0x0a}, {0x6d, 0x55}, 
	{0x6e, 0x11}, {0x6f, 0x9f},{0x6a, 0x40}, {R444_RGBX, 0x40}, 
	{R444_ENABLE, 0x40}, {REG_COM8, 0xe7}, {REG_COM10, 0x01}, 
	{0x4f, 0x80}, {0x50, 0x80}, {0x51, 0x00}, {0x52, 0x22}, 
	{0x53, 0x5e}, {0x54, 0x80}, {0x58, 0x9e},	{0x41, 0x08}, 
	{REG_EDGE, 0x00}, {0x75, 0x05}, {0x76, 0xe1}, {0x4c, 0x00}, 
	{0x77, 0x01},{0x4b, 0x09}, {0xc9, 0x60}, {0x41, 0x38}, 
	{REG_CONTRAS, 0x40},{0x34, 0x11}, {0x3b, 0x00},{0xa4, 0x88},
	{0x96, 0x00}, {0x97, 0x30}, {0x98, 0x20}, {0x99, 0x30}, 
	{0x9a, 0x84}, {0x9b, 0x29}, {0x9c, 0x03}, {0x9d, 0x4c}, 
	{0x9e, 0x3f}, {0x78, 0x04},	{0x79, 0x01}, {0xc8, 0xf0}, 
...
static struct regval_list ov7670_fmt_yuv422[] = {
	...
	{ REG_COM1, 0X40 },
	{ REG_COM15, 0x80 },
	{ REG_COM9, 0x48 }, /* 4x gain ceiling; 0x8 is reserved bit */
...
static struct regval_list ov7670_fmt_rgb565[] = {
	{ REG_COM7, 0x14 },	/* Selects RGB mode */
	{ REG_RGB444, 0 },	/* No RGB444 please */
	{ REG_COM1, 0x40 },
...
static struct regval_list ov7670_default_regs[] = {
	{0x12,0x80},{0x11,0x81},{0x92,0x00},{0x93,0x00},{0x2a,0x00},
	{0x2b,0x00},{0x3b,0x0a},{0x9d,0x66},{0x9e,0x66},{0x3a,0x0d},
	{0x12,0x00},{0x17,0x13},{0x18,0x01},{0x32,0xb6},{0x19,0x02},
	{0x1a,0x7a},{0x03,0x0a},{0x0c,0x00},{0x3e,0x00},{0x70,0x3a},
	{0x71,0x35},{0x72,0x11},{0x73,0xf0},{0xa2,0x02},{0x7a,0x20},
	{0x7b,0x10},{0x7c,0x1e},{0x7d,0x35},{0x7e,0x5a},{0x7f,0x69},
	{0x80,0x76},{0x81,0x80},{0x82,0x88},{0x83,0x8f},{0x84,0x96},
	{0x85,0xa3},{0x86,0xaf},{0x87,0xc4},{0x88,0xd7},{0x89,0xe8},
	{0x13,0xe0},{0x00,0x00},{0x10,0x00},{0x0d,0x60},{0x42,0x80},
	{0x14,0x18},{0xa5,0x07},{0xab,0x08},{0x24,0x44},{0x25,0x3c},
	{0x26,0x82},{0x9f,0x78},{0xa0,0x68},{0xa1,0x03},{0xa6,0xd8},
	{0xa7,0xd8},{0xa8,0xf0},{0xa9,0x90},{0xaa,0x14},{0x13,0xe5},
	{0x0e,0x61},{0x0f,0x4b},{0x16,0x02},{0x1e,0x07},{0x21,0x02},
	{0x22,0x91},{0x29,0x07},{0x33,0x0b},{0x35,0x0b},{0x37,0x1d},
	{0x38,0x71},{0x39,0x2a},{0x3c,0x78},{0x4d,0x40},{0x4e,0x20},
	{0x69,0x00},{0x6b,0x0a},{0x74,0x10},{0x8d,0x4f},{0x8e,0x00},
	{0x8f,0x00},{0x90,0x00},{0x91,0x00},{0x96,0x00},{0x9a,0x80},
	{0xb0,0x84},{0xb1,0x0c},{0xb2,0x0e},{0xb3,0x82},{0xb8,0x0a},
	{0x43,0x0a},{0x44,0xf0},{0x45,0x34},{0x46,0x58},{0x47,0x28},
	...
	{0x6f,0x9f},{0x6a,0x40},{0x01,0x40},{0x02,0x40},{0x13,0xe7},
	{0x58,0x9e},{0x41,0x08},{0x3f,0x00},{0x75,0x23},{0x76,0xe1},
	{0x4c,0x00},{0x77,0x00},{0x3d,0xc1},{0x4b,0x09},{0xc9,0x60},
	{0x41,0x38},{0x56,0x40},{0x34,0x11},{0xa4,0x88},{0x96,0x00},
	{0x97,0x30},{0x98,0x20},{0x99,0x30},{0x9a,0x84},{0x9b,0x29},
	{0x9c,0x03},{0x78,0x04},{0x79,0x01},{0xc8,0xf0},{0x79,0x0f},
	{0xc8,0x00},{0x79,0x10},{0xc8,0x7e},{0x79,0x0a},{0xc8,0x80},
	{0x79,0x0b},{0xc8,0x01},{0x79,0x0c},{0xc8,0x0f},{0x79,0x0d},
	{0xc8,0x20},{0x79,0x09},{0xc8,0x80},{0x79,0x02},{0xc8,0xc0},
	{0x79,0x03},{0xc8,0x40},{0x79,0x05},{0xc8,0x30},{0x79,0x26},
	{0x2d,0x00},{0x2e,0x00},
	{ 0xff, 0xff },	/* END MARKER */
};
...
static struct regval_list ov7670_fmt_rgb565[] = {
	{ REG_COM7, 0x04 },	/* Selects RGB mode */
	{ REG_RGB444, 0 },	/* No RGB444 please */
	{ REG_COM1, 0x40 },
	{ REG_COM15, COM15_RGB565 },
	{ REG_COM9, 0x28 }, 	/* 16x gain ceiling; 0x8 is reserved bit */
...
/* h/vref stuff */
	...
	/* QVGA */
	{
		...
		.hstart		= 176,		/* Empirically determined */
		.hstop		=  32,
		.vstart		=  10,
		.vstop		= 490,
		.regs 		= NULL,
...
static int ov7670_attach(struct i2c_adapter *adapter)
{
	 ...
	 */
	if (adapter->id != I2C_HW_SMBUS_ALP)
		return -ENODEV;
	...
	if (ret)
		goto out_free_info;
	printk(KERN_NOTICE "OmniVision ov7670 sensor init success!\n");
	return 0;
