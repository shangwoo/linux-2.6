...
/* Default LPI timers */
#define ASMMAC_DEFAULT_LIT_LS_TIMER	0x3E8
#define ASMMAC_DEFAULT_TWT_LS_TIMER	0x0

struct asmmac_desc_ops {
	...
	int (*tx_status) (void *data, struct asmmac_extra_stats *x,
	...
	int (*rx_status) (void *data, struct asmmac_extra_stats *x,
			  struct dma_desc *p);
};

struct asmmac_dma_ops {
	...
	void (*dma_diagnostic_fr) (void *data, struct asmmac_extra_stats *x,
				   void __iomem *ioaddr);
...
struct mac_device_info {
	const struct asmmac_ops		*mac;
	const struct asmmac_desc_ops	*desc;
	const struct asmmac_dma_ops	*dma;
	const struct asmmac_ring_mode_ops	*ring;
...
extern void asmmac_set_mac_addr(void __iomem *ioaddr, u8 addr[6],
				unsigned int high, unsigned int low);
extern void asmmac_get_mac_addr(void __iomem *ioaddr, unsigned char *addr,
				unsigned int high, unsigned int low);

extern void asmmac_set_mac(void __iomem *ioaddr, bool enable);

extern void dwmac_dma_flush_tx_fifo(void __iomem *ioaddr);
extern const struct asmmac_ring_mode_ops ring_mode_ops;
