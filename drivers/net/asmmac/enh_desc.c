...
static int enh_desc_get_tx_status(void *data, struct asmmac_extra_stats *x,
...
static int enh_desc_get_rx_status(void *data, struct asmmac_extra_stats *x,
				  struct dma_desc *p)
{
	int ret = good_frame;
	struct net_device_stats *stats = (struct net_device_stats *)data;
...
const struct asmmac_desc_ops enh_desc_ops = {
