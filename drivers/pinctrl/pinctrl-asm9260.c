...
static struct asm9260_pingroup asm9260_mux_table[] = {
	PMUX(120,	0,	0,	gpio0_0,	NA,	UART1_CLK,	I2S0_MCLK,	SPI1_SCK,	NA,	JTAG,	NA),
	PMUX(121,	0,	1,	gpio0_1,	NA,	UART1_TXD,	I2S0_BCLK,	SPI1_SEL,	NA,	JTAG,	NA),
	PMUX(122,	0,	2,	gpio0_2,	NA,	UART1_RXD,	I2S0_LRC,	SPI1_MISO,	NA,	JTAG,	NA),
	PMUX(123,	0,	3,	gpio0_3,	NA,	UART1_RTS,	I2S0_RX0,	SPI1_MOSI,	NA,	JTAG,	NA),
	PMUX(124,	0,	4,	gpio0_4,	NA,	UART1_CTS,	I2S0_TX0,	SPI0_SCK,	NA,	JTAG,	I2C0_SCL),
	PMUX(128,	1,	4,	gpio1_4,	CT0_CAP,	UART0_DTR,	LCD_IF_BUSY,	SPI0_SCK,	MII_PPS_OUT,	LCD_CP_OQ,	NA),
	PMUX(129,	1,	5,	gpio1_5,	NA,	UART0_DSR,	LCD_IF_WR,	SPI0_SEL,	RMII_REFCLK,	LCD_FP_OQ,	NA),
	PMUX(130,	1,	6,	gpio1_6,	NA,	UART0_DCD,	LCD_IF_RS,	SPI0_MISO,	RMII_REFCLK,	LCD_AC_OQ,	I2C1_SCL),
	PMUX(131,	1,	7,	gpio1_7,	NA,	UART0_RI,	LCD_IF_CS,	SPI0_MOSI,	RMII_REFCLK,	LCD_LP_OQ,	I2C1_SDA),
	PMUX(132,	2,	0,	gpio2_0,	CT1_MAT0,	UART2_RTS,	LCD_IF_DAT0,	SPI1_SCK,	MII_RXD2,	LCD_PIXEL_OQ0,	CAN0_TX),
	PMUX(133,	2,	1,	gpio2_1,	CT1_MAT1,	UART2_CTS,	LCD_IF_DAT1,	SPI1_SEL,	MII_RXD3,	LCD_PIXEL_OQ1,	CAN0_RX),
	PMUX(134,	2,	2,	gpio2_2,	CT1_MAT2,	UART3_CLK,	LCD_IF_DAT2,	SPI1_MISO,	MII_TXD2,	LCD_PIXEL_OQ2,	NA),
	PMUX(135,	2,	3,	gpio2_3,	CT1_MAT3,	UART3_TXD,	LCD_IF_DAT3,	SPI1_MOSI,	MII_TXD3,	LCD_PIXEL_OQ3,	NA),
	PMUX(136,	2,	4,	gpio2_4,	CT1_CAP,	UART3_RXD,	LCD_IF_DAT4,	NA,	MII_TX_CLK,	LCD_PIXEL_OQ4,	NA),
	PMUX(137,	2,	5,	gpio2_5,	NA,	UART3_RTS,	LCD_IF_DAT5,	NA,	MII_CRS,	LCD_PIXEL_OQ5,	OUTCLK),
	PMUX(138,	2,	6,	gpio2_6,	NA,	UART3_CTS,	LCD_IF_DAT6,	NA,	MII_COL,	LCD_PIXEL_OQ6,	CAN1_TX),
	PMUX(139,	2,	7,	gpio2_7,	NA,	UART4_CLK,	LCD_IF_DAT7,	NA,	MII_RX_ER,	LCD_PIXEL_OQ7,	CAN1_RX),
	PMUX(140,	3,	0,	gpio3_0,	CT2_MAT0,	UART4_TXD,	LCD_IF_DAT8,	SD0_CLK,	RMII_MDC,	LCD_PIXEL_OQ8,	NA),
	PMUX(141,	3,	1,	gpio3_1,	CT2_MAT1,	UART4_RXD,	LCD_IF_DAT9,	SD0_CMD,	RMII_MDIO,	LCD_PIXEL_OQ9,	NA),
	PMUX(142,	3,	2,	gpio3_2,	CT2_MAT2,	UART4_RTS,	LCD_IF_DAT10,	SD0_DAT0,	RMII_CRS_DV,	LCD_PIXEL_OQ10,	CAN1_TX),
	PMUX(143,	3,	3,	gpio3_3,	CT2_MAT3,	UART4_CTS,	LCD_IF_DAT11,	SD0_DAT1,	RMII_RXD0,	LCD_PIXEL_OQ11,	CAN1_RX),
	PMUX(144,	3,	4,	gpio3_4,	CT2_CAP,	UART5_CLK,	LCD_IF_DAT12,	SD0_DAT2,	RMII_RXD1,	LCD_PIXEL_OQ12,	OUTCLK),
	PMUX(145,	3,	5,	gpio3_5,	NA,	UART5_TXD,	LCD_IF_DAT13,	SD0_DAT3,	RMII_TX_EN,	LCD_PIXEL_OQ13,	I2C0_SCL),
	PMUX(146,	3,	6,	gpio3_6,	NA,	UART5_RXD,	LCD_IF_DAT14,	NA,	RMII_TXD0,	LCD_PIXEL_OQ14,	I2C0_SDA),
	PMUX(147,	3,	7,	gpio3_7,	NA,	UART5_RTS,	LCD_IF_DAT15,	NA,	RMII_TXD1,	LCD_PIXEL_OQ15,	NA),
	PMUX(151,	4,	0,	gpio4_0,	CT3_MAT0,	UART5_CTS,	NA,	QSPI0_SCK,	MII_RXD2,	LCD_PIXEL_OQ16,	NA),
	PMUX(152,	4,	1,	gpio4_1,	CT3_MAT1,	UART6_CLK,	NA,	QSPI0_SEL,	MII_RXD3,	LCD_PIXEL_OQ17,	NA),
	PMUX(153,	4,	2,	gpio4_2,	CT3_MAT2,	UART6_TXD,	NA,	QSPI0_DAT0,	MII_TXD2,	LCD_PIXEL_OQ18,	NA),
	PMUX(154,	4,	3,	gpio4_3,	CT3_MAT3,	UART6_RXD,	NA,	QSPI0_DAT1,	MII_TXD3,	LCD_PIXEL_OQ19,	NA),
	PMUX(155,	4,	4,	gpio4_4,	CT3_CAP,	UART6_RTS,	NA,	QSPI0_DAT2,	MII_TX_CLK,	LCD_PIXEL_OQ20,	NA),
	PMUX(156,	4,	5,	gpio4_5,	NA,	UART6_CTS,	NA,	QSPI0_DAT3,	MII_CRS,	LCD_PIXEL_OQ21,	NA),
	PMUX(157,	4,	6,	gpio4_6,	NA,	NA,	NA,	NA,	MII_COL,	LCD_PIXEL_OQ22,	I2C1_SCL),
	PMUX(158,	4,	7,	gpio4_7,	NA,	NA,	NA,	NA,	MII_RX_ER,	LCD_PIXEL_OQ23,	I2C1_SDA),
	PMUX(169,	5,	0,	gpio5_0,	MCIABORT,	UART7_TXD,	I2S1_MCLK,	SD0_CLK,	RMII_MDC,	NA,	NA),
	PMUX(170,	5,	1,	gpio5_1,	MCI0,	UART7_RXD,	I2S1_BCLK,	SD0_CMD,	RMII_MDIO,	NA,	NA),
	PMUX(171,	5,	2,	gpio5_2,	MCOA0,	UART7_RTS,	I2S1_LRC,	SD0_DAT0,	RMII_CRS_DV,	NA,	CAN0_TX),
	PMUX(172,	5,	3,	gpio5_3,	MCOB0,	UART7_CTS,	I2S1_RX0,	SD0_DAT1,	RMII_RXD0,	NA,	CAN0_RX),
	PMUX(173,	5,	4,	gpio5_4,	MCI1,	UART8_TXD,	I2S1_TX0,	SD0_DAT2,	RMII_RXD1,	NA,	NA),
	PMUX(51,	8,	1,	gpio8_1,	NA,	UART2_TXD,	CAM_PCLK,	NA,	MII_RXD3,	NA,	NA),
	PMUX(52,	8,	2,	gpio8_2,	NA,	UART2_RXD,	CAM_VSYN,	NA,	MII_TXD2,	NA,	NA),
	PMUX(53,	8,	3,	gpio8_3,	NA,	UART2_RTS,	CAM_HREF,	NA,	MII_TXD3,	NA,	NA),
	PMUX(54,	8,	4,	gpio8_4,	NA,	UART2_CTS,	CAM_DAT0,	NA,	MII_TX_CLK,	NA,	NA),
	PMUX(55,	8,	5,	gpio8_5,	NA,	UART3_CLK,	CAM_DAT1,	NA,	MII_CRS,	NA,	NA),
	PMUX(56,	8,	6,	gpio8_6,	NA,	UART3_TXD,	CAM_DAT2,	NA,	MII_COL,	NA,	NA),
	PMUX(57,	8,	7,	gpio8_7,	NA,	UART3_RXD,	CAM_DAT3,	NA,	MII_RX_ER,	NA,	NA),
	PMUX(45,	9,	0,	gpio9_0,	CT0_MAT0,	UART3_RTS,	CAM_DAT4,	NA,	RMII_MDC,	NA,	I2C0_SCL),
	PMUX(46,	9,	1,	gpio9_1,	CT0_MAT1,	UART3_CTS,	CAM_DAT5,	NA,	RMII_MDIO,	NA,	I2C0_SDA),
	PMUX(47,	9,	2,	gpio9_2,	CT0_MAT2,	UART4_CLK,	CAM_DAT6,	NA,	RMII_CRS_DV,	NA,	NA),
	PMUX(48,	9,	3,	gpio9_3,	CT0_MAT3,	UART4_TXD,	CAM_DAT7,	NA,	RMII_RXD0,	NA,	NA),
	PMUX(49,	9,	4,	gpio9_4,	CT0_CAP,	UART4_RXD,	CAM_DAT8,	NA,	RMII_RXD1,	NA,	NA),
	PMUX(50,	9,	5,	gpio9_5,	NA,	UART4_RTS,	CAM_DAT9,	NA,	RMII_TX_EN,	NA,	I2C1_SCL),
	PMUX(4,	10,	0,	gpio10_0,	CT1_MAT0,	UART5_TXD,	I2S0_MCLK,	SPI0_SCK,	NA,	NA,	NA),
	PMUX(5,	10,	1,	gpio10_1,	CT1_MAT1,	UART5_RXD,	I2S0_BCLK,	SPI0_SEL,	RMII_REFCLK,	NA,	NA),
	PMUX(6,	10,	2,	gpio10_2,	CT1_MAT2,	UART5_RTS,	I2S0_LRC,	SPI0_MISO,	RMII_REFCLK,	NA,	NA),
	PMUX(7,	10,	3,	gpio10_3,	CT1_MAT3,	UART5_CTS,	I2S0_RX0,	SPI0_MOSI,	NA,	NA,	CAN0_RX),
	PMUX(8,	10,	4,	gpio10_4,	CT1_CAP,	UART6_TXD,	I2S0_TX0,	SPI1_SCK,	RMII_REFCLK,	NA,	NA),
	PMUX(9,	10,	5,	gpio10_5,	NA,	UART6_RXD,	I2S0_TX1,	SPI1_SEL,	RMII_REFCLK,	NA,	CAN1_RX),
	PMUX(10,	10,	6,	gpio10_6,	NA,	UART6_RTS,	I2S0_TX2,	SPI1_MISO,	RMII_REFCLK,	NA,	CAN1_TX),
	PMUX(11,	10,	7,	gpio10_7,	NA,	UART6_CTS,	CAM_MCLK,	SPI1_MOSI,	RMII_REFCLK,	NA,	NA),
	PMUX(12,	11,	0,	gpio11_0,	CT2_MAT0,	UART7_TXD,	I2S1_MCLK,	QSPI0_SCK,	NAND_REN,	NA,	NA),
	PMUX(13,	11,	1,	gpio11_1,	CT2_MAT1,	UART7_RXD,	I2S1_BCLK,	QSPI0_SEL,	NAND_WEN,	NA,	NA),
	PMUX(14,	11,	2,	gpio11_2,	CT2_MAT2,	UART7_RTS,	I2S1_LRC,	QSPI0_DAT0,	NAND_ALE,	NA,	NA),
	PMUX(15,	11,	3,	gpio11_3,	CT2_MAT3,	UART7_CTS,	I2S1_RX0,	QSPI0_DAT1,	NAND_CLE,	NA,	NA),
	PMUX(16,	11,	4,	gpio11_4,	CT2_CAP,	UART8_TXD,	I2S1_TX0,	QSPI0_DAT2,	NAND_RDY0,	NA,	NA),
	PMUX(17,	11,	5,	gpio11_5,	NA,	UART8_RXD,	I2S1_TX1,	QSPI0_DAT3,	NAND_RDY1,	NA,	NA),
	PMUX(18,	11,	6,	gpio11_6,	NA,	UART9_TXD,	I2S1_TX2,	NA,	NAND_CE0N,	NA,	I2C0_SCL),
	PMUX(19,	11,	7,	gpio11_7,	NA,	UART9_RXD,	CAM_MCLK,	NA,	NAND_CE1N,	NA,	I2C0_SDA),
	PMUX(23,	12,	0,	gpio12_0,	CT3_MAT0,	UART1_CLK,	NA,	SD0_CLK,	NAND_D0,	NA,	NA),
	PMUX(24,	12,	1,	gpio12_1,	CT3_MAT1,	UART1_TXD,	NA,	SD0_CMD,	NAND_D1,	NA,	NA),
	PMUX(25,	12,	2,	gpio12_2,	CT3_MAT2,	UART1_RXD,	NA,	SD0_DAT0,	NAND_D2,	NA,	NA),
	PMUX(26,	12,	3,	gpio12_3,	CT3_MAT3,	UART1_RTS,	NA,	SD0_DAT1,	NAND_D3,	NA,	NA),
	PMUX(27,	12,	4,	gpio12_4,	CT3_CAP,	UART1_CTS,	NA,	SD0_DAT2,	NAND_D4,	NA,	NA),
	PMUX(28,	12,	5,	gpio12_5,	NA,	UART8_TXD,	NA,	SD0_DAT3,	NAND_D5,	NA,	NA),
	PMUX(29,	12,	6,	gpio12_6,	NA,	UART8_RXD,	CAM_MCLK,	NA,	NAND_D6,	NA,	I2C1_SCL),
	PMUX(30,	12,	7,	gpio12_7,	NA,	NA,	CAM_MCLK,	NA,	NAND_D7,	NA,	I2C1_SDA),
	PMUX(31,	13,	4,	gpio13_4,	MCI1,	UART2_CTS,	NA,	SPI1_SCK,	NAND_RDY0,	NA,	NA),
	PMUX(32,	13,	5,	gpio13_5,	MCOA1,	UART9_TXD,	NA,	SPI1_SEL,	NAND_RDY1,	NA,	NA),
	PMUX(33,	13,	6,	gpio13_6,	MCOB1,	UART9_RXD,	NA,	SPI1_MISO,	NAND_CE0N,	NA,	NA),
	PMUX(34,	13,	7,	gpio13_7,	MCI2,	NA,	NA,	SPI1_MOSI,	NAND_CE1N,	NA,	NA),
	PMUX(38,	14,	0,	gpio14_0,	MCOA2,	UART0_TXD,	I2S0_MCLK,	SD0_CLK,	NAND_D0,	NA,	NA),
	PMUX(39,	14,	1,	gpio14_1,	MCOB2,	UART0_RXD,	I2S0_BCLK,	SD0_CMD,	NAND_D1,	NA,	NA),
	PMUX(40,	14,	2,	gpio14_2,	NA,	UART0_RTS,	I2S0_LRC,	SD0_DAT0,	NAND_D2,	NA,	NA),
	PMUX(41,	14,	3,	gpio14_3,	NA,	UART0_CTS,	I2S0_RX0,	SD0_DAT1,	NAND_D3,	NA,	NA),
	PMUX(42,	14,	4,	gpio14_4,	NA,	UART0_DTR,	I2S0_TX0,	SD0_DAT2,	NAND_D4,	NA,	NA),
	PMUX(43,	14,	5,	gpio14_5,	NA,	UART0_DSR,	I2S0_TX1,	SD0_DAT3,	NAND_D5,	NA,	NA),
	PMUX(44,	15,	0,	gpio15_0,	NA,	UART4_TXD,	I2S0_MCLK,	SD0_CLK,	RMII_MDC,	NA,	NA),
	PMUX(61,	15,	1,	gpio15_1,	NA,	UART4_RXD,	I2S0_BCLK,	SD0_CMD,	RMII_MDIO,	NA,	NA),
	PMUX(62,	15,	2,	gpio15_2,	NA,	UART5_TXD,	I2S0_LRC,	SD0_DAT0,	RMII_CRS_DV,	NA,	NA),
	PMUX(63,	15,	3,	gpio15_3,	NA,	UART5_RXD,	I2S0_RX0,	SD0_DAT1,	RMII_RXD0,	NA,	NA),
	PMUX(64,	15,	4,	gpio15_4,	NA,	UART6_TXD,	I2S0_TX0,	SD0_DAT2,	RMII_RXD1,	NA,	NA),
	PMUX(65,	15,	5,	gpio15_5,	NA,	UART6_RXD,	I2S0_TX1,	SD0_DAT3,	RMII_TX_EN,	NA,	NA),
	PMUX(66,	15,	6,	gpio15_6,	NA,	UART7_TXD,	I2S0_TX2,	NA,	RMII_TXD0,	NA,	NA),
	PMUX(67,	15,	7,	gpio15_7,	NA,	UART7_RXD,	NA,	NA,	RMII_TXD1,	NA,	NA),
	PMUX(73,	16,	0,	gpio16_0,	CT2_MAT0,	UART4_TXD,	NA,	NA,	MII_RXD2,	NA,	NA),
	PMUX(74,	16,	1,	gpio16_1,	CT2_MAT1,	UART4_RXD,	NA,	NA,	MII_RXD3,	NA,	NA),
	PMUX(75,	16,	2,	gpio16_2,	CT2_MAT2,	UART5_TXD,	NA,	NA,	MII_TXD2,	NA,	NA),
	PMUX(76,	16,	3,	gpio16_3,	CT2_MAT3,	UART5_RXD,	NA,	NA,	MII_TXD3,	NA,	NA),
	PMUX(77,	16,	4,	gpio16_4,	CT2_CAP,	UART6_TXD,	NA,	NA,	MII_TX_CLK,	NA,	NA),
	PMUX(78,	16,	5,	gpio16_5,	QEI_A,	UART6_RXD,	NA,	NA,	MII_CRS,	NA,	NA),
	PMUX(79,	16,	6,	gpio16_6,	QEI_B,	UART6_RTS,	NA,	NA,	MII_COL,	NA,	CAN1_TX),
	PMUX(80,	16,	7,	gpio16_7,	QEI_INDEX,	UART6_CTS,	NA,	NA,	MII_RX_ER,	NA,	CAN1_RX),
	PMUX(81,	17,	0,	gpio17_0,	CT3_MAT0,	UART7_TXD,	I2S1_MCLK,	NA,	RMII_REFCLK,	NA,	NA),
	PMUX(82,	17,	1,	gpio17_1,	CT3_MAT1,	UART7_RXD,	I2S1_BCLK,	NA,	NA,	NA,	NA),
	PMUX(83,	17,	2,	gpio17_2,	CT3_MAT2,	UART7_RTS,	I2S1_LRC,	NA,	NA,	NA,	I2C1_SCL),
	PMUX(84,	17,	3,	gpio17_3,	CT3_MAT3,	UART7_CTS,	I2S1_RX0,	NA,	NA,	NA,	I2C1_SDA),
	PMUX(85,	17,	4,	gpio17_4,	CT3_CAP,	UART8_TXD,	I2S1_TX0,	NA,	NA,	NA,	NA),
	PMUX(86,	17,	5,	gpio17_5,	QEI_A,	UART8_RXD,	I2S1_TX1,	NA,	RMII_REFCLK,	NA,	NA),
	PMUX(87,	17,	6,	gpio17_6,	QEI_B,	UART9_TXD,	I2S1_TX2,	NA,	MII_PPS_OUT,	NA,	NA),
...
static int asm9260_pinctrl_set_mux_mux(struct asm9260_pmx *pmx,
				     const struct asm9260_pingroup *desc,
				     unsigned int function)
{
	const int *fit;
	//unsigned long flags;
