...
#define PMUX(p_bank, p_pin, p_name, f1, f2, f3, f4, f5, f6, f7) \
	{						\
		.bank = p_bank,				\
		.pin = p_pin,				\
		.name = #p_name,			\
...
static struct asm9260_pingroup asm9260_mux_table[] = {
	...
	PMUX(0,	3,	GPIO0_3,	NA,	UART1_RTS,	I2S0_RX0,	SPI1_MOSI,	NA,	JTAG,	NA),
	PMUX(0,	4,	GPIO0_4,	NA,	UART1_CTS,	I2S0_TX0,	SPI0_SCK,	NA,	JTAG,	I2C0_SCL),
	PMUX(1,	4,	GPIO1_4,	CT0_CAP,	UART0_DTR,	LCD_IF_BUSY,	SPI0_SCK,	MII_PPS_OUT,	LCD_CP_OQ,	NA),
	PMUX(1,	5,	GPIO1_5,	NA,	UART0_DSR,	LCD_IF_WR,	SPI0_SEL,	RMII_REFCLK,	LCD_FP_OQ,	NA),
	PMUX(1,	6,	GPIO1_6,	NA,	UART0_DCD,	LCD_IF_RS,	SPI0_MISO,	RMII_REFCLK,	LCD_AC_OQ,	I2C1_SCL),
	PMUX(1,	7,	GPIO1_7,	NA,	UART0_RI,	LCD_IF_CS,	SPI0_MOSI,	RMII_REFCLK,	LCD_LP_OQ,	I2C1_SDA),
	PMUX(2,	0,	GPIO2_0,	CT1_MAT0,	UART2_RTS,	LCD_IF_DAT0,	SPI1_SCK,	MII_RXD2,	LCD_PIXEL_OQ0,	CAN0_TX),
	PMUX(2,	1,	GPIO2_1,	CT1_MAT1,	UART2_CTS,	LCD_IF_DAT1,	SPI1_SEL,	MII_RXD3,	LCD_PIXEL_OQ1,	CAN0_RX),
	PMUX(2,	2,	GPIO2_2,	CT1_MAT2,	UART3_CLK,	LCD_IF_DAT2,	SPI1_MISO,	MII_TXD2,	LCD_PIXEL_OQ2,	NA),
	PMUX(2,	3,	GPIO2_3,	CT1_MAT3,	UART3_TXD,	LCD_IF_DAT3,	SPI1_MOSI,	MII_TXD3,	LCD_PIXEL_OQ3,	NA),
	PMUX(2,	4,	GPIO2_4,	CT1_CAP,	UART3_RXD,	LCD_IF_DAT4,	NA,	MII_TX_CLK,	LCD_PIXEL_OQ4,	NA),
	PMUX(2,	5,	GPIO2_5,	NA,	UART3_RTS,	LCD_IF_DAT5,	NA,	MII_CRS,	LCD_PIXEL_OQ5,	OUTCLK),
	PMUX(2,	6,	GPIO2_6,	NA,	UART3_CTS,	LCD_IF_DAT6,	NA,	MII_COL,	LCD_PIXEL_OQ6,	CAN1_TX),
	PMUX(2,	7,	GPIO2_7,	NA,	UART4_CLK,	LCD_IF_DAT7,	NA,	MII_RX_ER,	LCD_PIXEL_OQ7,	CAN1_RX),
	PMUX(3,	0,	GPIO3_0,	CT2_MAT0,	UART4_TXD,	LCD_IF_DAT8,	SD0_CLK,	RMII_MDC,	LCD_PIXEL_OQ8,	NA),
	PMUX(3,	1,	GPIO3_1,	CT2_MAT1,	UART4_RXD,	LCD_IF_DAT9,	SD0_CMD,	RMII_MDIO,	LCD_PIXEL_OQ9,	NA),
	PMUX(3,	2,	GPIO3_2,	CT2_MAT2,	UART4_RTS,	LCD_IF_DAT10,	SD0_DAT0,	RMII_CRS_DV,	LCD_PIXEL_OQ10,	CAN1_TX),
	PMUX(3,	3,	GPIO3_3,	CT2_MAT3,	UART4_CTS,	LCD_IF_DAT11,	SD0_DAT1,	RMII_RXD0,	LCD_PIXEL_OQ11,	CAN1_RX),
	PMUX(3,	4,	GPIO3_4,	CT2_CAP,	UART5_CLK,	LCD_IF_DAT12,	SD0_DAT2,	RMII_RXD1,	LCD_PIXEL_OQ12,	OUTCLK),
	PMUX(3,	5,	GPIO3_5,	NA,	UART5_TXD,	LCD_IF_DAT13,	SD0_DAT3,	RMII_TX_EN,	LCD_PIXEL_OQ13,	I2C0_SCL),
	PMUX(3,	6,	GPIO3_6,	NA,	UART5_RXD,	LCD_IF_DAT14,	NA,	RMII_TXD0,	LCD_PIXEL_OQ14,	I2C0_SDA),
	PMUX(3,	7,	GPIO3_7,	NA,	UART5_RTS,	LCD_IF_DAT15,	NA,	RMII_TXD1,	LCD_PIXEL_OQ15,	NA),
	PMUX(4,	0,	GPIO4_0,	CT3_MAT0,	UART5_CTS,	NA,	QSPI0_SCK,	MII_RXD2,	LCD_PIXEL_OQ16,	NA),
	PMUX(4,	1,	GPIO4_1,	CT3_MAT1,	UART6_CLK,	NA,	QSPI0_SEL,	MII_RXD3,	LCD_PIXEL_OQ17,	NA),
	PMUX(4,	2,	GPIO4_2,	CT3_MAT2,	UART6_TXD,	NA,	QSPI0_DAT0,	MII_TXD2,	LCD_PIXEL_OQ18,	NA),
	PMUX(4,	3,	GPIO4_3,	CT3_MAT3,	UART6_RXD,	NA,	QSPI0_DAT1,	MII_TXD3,	LCD_PIXEL_OQ19,	NA),
	PMUX(4,	4,	GPIO4_4,	CT3_CAP,	UART6_RTS,	NA,	QSPI0_DAT2,	MII_TX_CLK,	LCD_PIXEL_OQ20,	NA),
	PMUX(4,	5,	GPIO4_5,	NA,	UART6_CTS,	NA,	QSPI0_DAT3,	MII_CRS,	LCD_PIXEL_OQ21,	NA),
	PMUX(4,	6,	GPIO4_6,	NA,	NA,	NA,	NA,	MII_COL,	LCD_PIXEL_OQ22,	I2C1_SCL),
	PMUX(4,	7,	GPIO4_7,	NA,	NA,	NA,	NA,	MII_RX_ER,	LCD_PIXEL_OQ23,	I2C1_SDA),
	PMUX(5,	0,	GPIO5_0,	MCIABORT,	UART7_TXD,	I2S1_MCLK,	SD0_CLK,	RMII_MDC,	NA,	NA),
	PMUX(5,	1,	GPIO5_1,	MCI0,	UART7_RXD,	I2S1_BCLK,	SD0_CMD,	RMII_MDIO,	NA,	NA),
	PMUX(5,	2,	GPIO5_2,	MCOA0,	UART7_RTS,	I2S1_LRC,	SD0_DAT0,	RMII_CRS_DV,	NA,	CAN0_TX),
	PMUX(5,	3,	GPIO5_3,	MCOB0,	UART7_CTS,	I2S1_RX0,	SD0_DAT1,	RMII_RXD0,	NA,	CAN0_RX),
	PMUX(5,	4,	GPIO5_4,	MCI1,	UART8_TXD,	I2S1_TX0,	SD0_DAT2,	RMII_RXD1,	NA,	NA),
	PMUX(8,	1,	GPIO8_1,	NA,	UART2_TXD,	CAM_PCLK,	NA,	MII_RXD3,	NA,	NA),
	PMUX(8,	2,	GPIO8_2,	NA,	UART2_RXD,	CAM_VSYN,	NA,	MII_TXD2,	NA,	NA),
	PMUX(8,	3,	GPIO8_3,	NA,	UART2_RTS,	CAM_HREF,	NA,	MII_TXD3,	NA,	NA),
	PMUX(8,	4,	GPIO8_4,	NA,	UART2_CTS,	CAM_DAT0,	NA,	MII_TX_CLK,	NA,	NA),
	PMUX(8,	5,	GPIO8_5,	NA,	UART3_CLK,	CAM_DAT1,	NA,	MII_CRS,	NA,	NA),
	PMUX(8,	6,	GPIO8_6,	NA,	UART3_TXD,	CAM_DAT2,	NA,	MII_COL,	NA,	NA),
	PMUX(8,	7,	GPIO8_7,	NA,	UART3_RXD,	CAM_DAT3,	NA,	MII_RX_ER,	NA,	NA),
	PMUX(9,	0,	GPIO9_0,	CT0_MAT0,	UART3_RTS,	CAM_DAT4,	NA,	RMII_MDC,	NA,	I2C0_SCL),
	PMUX(9,	1,	GPIO9_1,	CT0_MAT1,	UART3_CTS,	CAM_DAT5,	NA,	RMII_MDIO,	NA,	I2C0_SDA),
	PMUX(9,	2,	GPIO9_2,	CT0_MAT2,	UART4_CLK,	CAM_DAT6,	NA,	RMII_CRS_DV,	NA,	NA),
	PMUX(9,	3,	GPIO9_3,	CT0_MAT3,	UART4_TXD,	CAM_DAT7,	NA,	RMII_RXD0,	NA,	NA),
	PMUX(9,	4,	GPIO9_4,	CT0_CAP,	UART4_RXD,	CAM_DAT8,	NA,	RMII_RXD1,	NA,	NA),
	PMUX(9,	5,	GPIO9_5,	NA,	UART4_RTS,	CAM_DAT9,	NA,	RMII_TX_EN,	NA,	I2C1_SCL),
	PMUX(10,	0,	GPIO10_0,	CT1_MAT0,	UART5_TXD,	I2S0_MCLK,	SPI0_SCK,	NA,	NA,	NA),
	PMUX(10,	1,	GPIO10_1,	CT1_MAT1,	UART5_RXD,	I2S0_BCLK,	SPI0_SEL,	RMII_REFCLK,	NA,	NA),
	PMUX(10,	2,	GPIO10_2,	CT1_MAT2,	UART5_RTS,	I2S0_LRC,	SPI0_MISO,	RMII_REFCLK,	NA,	NA),
	PMUX(10,	3,	GPIO10_3,	CT1_MAT3,	UART5_CTS,	I2S0_RX0,	SPI0_MOSI,	NA,	NA,	CAN0_RX),
	PMUX(10,	4,	GPIO10_4,	CT1_CAP,	UART6_TXD,	I2S0_TX0,	SPI1_SCK,	RMII_REFCLK,	NA,	NA),
	PMUX(10,	5,	GPIO10_5,	NA,	UART6_RXD,	I2S0_TX1,	SPI1_SEL,	RMII_REFCLK,	NA,	CAN1_RX),
	PMUX(10,	6,	GPIO10_6,	NA,	UART6_RTS,	I2S0_TX2,	SPI1_MISO,	RMII_REFCLK,	NA,	CAN1_TX),
	PMUX(10,	7,	GPIO10_7,	NA,	UART6_CTS,	CAM_MCLK,	SPI1_MOSI,	RMII_REFCLK,	NA,	NA),
	PMUX(11,	0,	GPIO11_0,	CT2_MAT0,	UART7_TXD,	I2S1_MCLK,	QSPI0_SCK,	NAND_REN,	NA,	NA),
	PMUX(11,	1,	GPIO11_1,	CT2_MAT1,	UART7_RXD,	I2S1_BCLK,	QSPI0_SEL,	NAND_WEN,	NA,	NA),
	PMUX(11,	2,	GPIO11_2,	CT2_MAT2,	UART7_RTS,	I2S1_LRC,	QSPI0_DAT0,	NAND_ALE,	NA,	NA),
	PMUX(11,	3,	GPIO11_3,	CT2_MAT3,	UART7_CTS,	I2S1_RX0,	QSPI0_DAT1,	NAND_CLE,	NA,	NA),
	PMUX(11,	4,	GPIO11_4,	CT2_CAP,	UART8_TXD,	I2S1_TX0,	QSPI0_DAT2,	NAND_RDY0,	NA,	NA),
	PMUX(11,	5,	GPIO11_5,	NA,	UART8_RXD,	I2S1_TX1,	QSPI0_DAT3,	NAND_RDY1,	NA,	NA),
	PMUX(11,	6,	GPIO11_6,	NA,	UART9_TXD,	I2S1_TX2,	NA,	NAND_CE0N,	NA,	I2C0_SCL),
	PMUX(11,	7,	GPIO11_7,	NA,	UART9_RXD,	CAM_MCLK,	NA,	NAND_CE1N,	NA,	I2C0_SDA),
	PMUX(12,	0,	GPIO12_0,	CT3_MAT0,	UART1_CLK,	NA,	SD0_CLK,	NAND_D0,	NA,	NA),
	PMUX(12,	1,	GPIO12_1,	CT3_MAT1,	UART1_TXD,	NA,	SD0_CMD,	NAND_D1,	NA,	NA),
	PMUX(12,	2,	GPIO12_2,	CT3_MAT2,	UART1_RXD,	NA,	SD0_DAT0,	NAND_D2,	NA,	NA),
	PMUX(12,	3,	GPIO12_3,	CT3_MAT3,	UART1_RTS,	NA,	SD0_DAT1,	NAND_D3,	NA,	NA),
	PMUX(12,	4,	GPIO12_4,	CT3_CAP,	UART1_CTS,	NA,	SD0_DAT2,	NAND_D4,	NA,	NA),
	PMUX(12,	5,	GPIO12_5,	NA,	UART8_TXD,	NA,	SD0_DAT3,	NAND_D5,	NA,	NA),
	PMUX(12,	6,	GPIO12_6,	NA,	UART8_RXD,	CAM_MCLK,	NA,	NAND_D6,	NA,	I2C1_SCL),
	PMUX(12,	7,	GPIO12_7,	NA,	NA,	CAM_MCLK,	NA,	NAND_D7,	NA,	I2C1_SDA),
	PMUX(13,	4,	GPIO13_4,	MCI1,	UART2_CTS,	NA,	SPI1_SCK,	NAND_RDY0,	NA,	NA),
	PMUX(13,	5,	GPIO13_5,	MCOA1,	UART9_TXD,	NA,	SPI1_SEL,	NAND_RDY1,	NA,	NA),
	PMUX(13,	6,	GPIO13_6,	MCOB1,	UART9_RXD,	NA,	SPI1_MISO,	NAND_CE0N,	NA,	NA),
	PMUX(13,	7,	GPIO13_7,	MCI2,	NA,	NA,	SPI1_MOSI,	NAND_CE1N,	NA,	NA),
	PMUX(14,	0,	GPIO14_0,	MCOA2,	UART0_TXD,	I2S0_MCLK,	SD0_CLK,	NAND_D0,	NA,	NA),
	PMUX(14,	1,	GPIO14_1,	MCOB2,	UART0_RXD,	I2S0_BCLK,	SD0_CMD,	NAND_D1,	NA,	NA),
	PMUX(14,	2,	GPIO14_2,	NA,	UART0_RTS,	I2S0_LRC,	SD0_DAT0,	NAND_D2,	NA,	NA),
	PMUX(14,	3,	GPIO14_3,	NA,	UART0_CTS,	I2S0_RX0,	SD0_DAT1,	NAND_D3,	NA,	NA),
	PMUX(14,	4,	GPIO14_4,	NA,	UART0_DTR,	I2S0_TX0,	SD0_DAT2,	NAND_D4,	NA,	NA),
	PMUX(14,	5,	GPIO14_5,	NA,	UART0_DSR,	I2S0_TX1,	SD0_DAT3,	NAND_D5,	NA,	NA),
	PMUX(15,	0,	GPIO15_0,	NA,	UART4_TXD,	I2S0_MCLK,	SD0_CLK,	RMII_MDC,	NA,	NA),
	PMUX(15,	1,	GPIO15_1,	NA,	UART4_RXD,	I2S0_BCLK,	SD0_CMD,	RMII_MDIO,	NA,	NA),
	PMUX(15,	2,	GPIO15_2,	NA,	UART5_TXD,	I2S0_LRC,	SD0_DAT0,	RMII_CRS_DV,	NA,	NA),
	PMUX(15,	3,	GPIO15_3,	NA,	UART5_RXD,	I2S0_RX0,	SD0_DAT1,	RMII_RXD0,	NA,	NA),
	PMUX(15,	4,	GPIO15_4,	NA,	UART6_TXD,	I2S0_TX0,	SD0_DAT2,	RMII_RXD1,	NA,	NA),
	PMUX(15,	5,	GPIO15_5,	NA,	UART6_RXD,	I2S0_TX1,	SD0_DAT3,	RMII_TX_EN,	NA,	NA),
	PMUX(15,	6,	GPIO15_6,	NA,	UART7_TXD,	I2S0_TX2,	NA,	RMII_TXD0,	NA,	NA),
	PMUX(15,	7,	GPIO15_7,	NA,	UART7_RXD,	NA,	NA,	RMII_TXD1,	NA,	NA),
	PMUX(16,	0,	GPIO16_0,	CT2_MAT0,	UART4_TXD,	NA,	NA,	MII_RXD2,	NA,	NA),
	PMUX(16,	1,	GPIO16_1,	CT2_MAT1,	UART4_RXD,	NA,	NA,	MII_RXD3,	NA,	NA),
	PMUX(16,	2,	GPIO16_2,	CT2_MAT2,	UART5_TXD,	NA,	NA,	MII_TXD2,	NA,	NA),
	PMUX(16,	3,	GPIO16_3,	CT2_MAT3,	UART5_RXD,	NA,	NA,	MII_TXD3,	NA,	NA),
	PMUX(16,	4,	GPIO16_4,	CT2_CAP,	UART6_TXD,	NA,	NA,	MII_TX_CLK,	NA,	NA),
	PMUX(16,	5,	GPIO16_5,	QEI_A,	UART6_RXD,	NA,	NA,	MII_CRS,	NA,	NA),
	PMUX(16,	6,	GPIO16_6,	QEI_B,	UART6_RTS,	NA,	NA,	MII_COL,	NA,	CAN1_TX),
	PMUX(16,	7,	GPIO16_7,	QEI_INDEX,	UART6_CTS,	NA,	NA,	MII_RX_ER,	NA,	CAN1_RX),
	PMUX(17,	0,	GPIO17_0,	CT3_MAT0,	UART7_TXD,	I2S1_MCLK,	NA,	RMII_REFCLK,	NA,	NA),
	PMUX(17,	1,	GPIO17_1,	CT3_MAT1,	UART7_RXD,	I2S1_BCLK,	NA,	NA,	NA,	NA),
	PMUX(17,	2,	GPIO17_2,	CT3_MAT2,	UART7_RTS,	I2S1_LRC,	NA,	NA,	NA,	I2C1_SCL),
	PMUX(17,	3,	GPIO17_3,	CT3_MAT3,	UART7_CTS,	I2S1_RX0,	NA,	NA,	NA,	I2C1_SDA),
	PMUX(17,	4,	GPIO17_4,	CT3_CAP,	UART8_TXD,	I2S1_TX0,	NA,	NA,	NA,	NA),
	PMUX(17,	5,	GPIO17_5,	QEI_A,	UART8_RXD,	I2S1_TX1,	NA,	RMII_REFCLK,	NA,	NA),
	PMUX(17,	6,	GPIO17_6,	QEI_B,	UART9_TXD,	I2S1_TX2,	NA,	MII_PPS_OUT,	NA,	NA),
